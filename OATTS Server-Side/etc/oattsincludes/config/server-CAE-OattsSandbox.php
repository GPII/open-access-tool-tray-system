...
define("BASEIP",'oattssandbox.trace.wisc.edu');

define("HOST", "mysql.cae.wisc.edu");	// The host you want to connect to.
define("USER", "oattie2");	// The database username. 
define("PASSWORD", 'TC0@!!$db');// The database password. 
define("DATABASE", "oattssandbox");	// The database name.
